        ...
        <div className="footer-container">
            <div className="footer-grid">
                ...
                <div className="footer-col">
                    <h4>Contact Us</h4>
                    <div>
                      <p style={{ color: '#fff' }}>Info@paragonlandscape.ge</p>
                      <p style={{ color: '#fff' }}>+995 510 00 44 99</p>
                    </div>
                </div>
                ...
                <div className="footer-social">
                    <h4>Follow Us</h4>
                    <div className="card">
                    <a className="socialContainer containerOne" href="https://www.instagram.com/paragon_landscape/" target="_blank">
                    ...
                    <a className="socialContainer containerTwo" href="https://www.facebook.com/profile.php?id=61584730146091" target="_blank">
                        <svg viewBox="0 0 640 640" className="socialSvg facebookSvg"> <path d="M240 363.3L240 576L356 576L356 363.3L442.5 363.3L460.5 265.5L356 265.5L356 230.9C356 179.2 376.3 159.4 428.7 159.4C445 159.4 458.1 159.8 465.7 160.6L465.7 71.9C451.4 68 416.4 64 396.2 64C289.3 64 240 114.5 240 223.4L240 265.5L174 265.5L174 363.3L240 363.3z"></path> </svg></a>
                        
                    <a className="socialContainer containerThree" href="https://www.linkedin.com/company/paragonlandscape/" target="_blank">
                    ...
                    <a className="socialContainer containerFour" href="https://wa.me/995510004499" target="_blank">
            ...
            <div className="footer-bottom">
                <p>© 2024 Paragon Landscapes. All rights reserved.</p>
